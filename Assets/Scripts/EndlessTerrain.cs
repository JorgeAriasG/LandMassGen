...
public class EndlessTerrain : MonoBehaviour
{
        ...
        for(int yOffset = -chunksVisibleInViewDistance; yOffset < chunksVisibleInViewDistance; yOffset++) {
            for(int xOffset = -chunksVisibleInViewDistance; xOffset < chunksVisibleInViewDistance; xOffset++) {
                ...
                if(terrainChunkDictionary.ContainsKey(viewdChunkCoord)) {
                    ...
                    terrainChunkDictionary.Add(viewdChunkCoord, new TerrainChunk(viewdChunkCoord, chunkSize));
                }
            }   
        }
    }
    ...
    public class TerrainChunk { 
        ...
        public void UpdateTerrainChunk() { 
            float viewerDisctanceFromNearestEdge = Mathf.Sqrt(bounds.SqrDistance(viewerPosition));
            bool isVisible = viewerDisctanceFromNearestEdge <= maxViewDistance;
